export const Skills = () => {
    return <>
        <div className=" font-serif h-full bg-indigo-950 text-white flex flex-col justify-center items-center text-3xl">
            ...
            <div className=" m-4 lg:flex gap-6 max-md:w-[20rem] overflow-auto projects">
                <div className="spotify  max-lg:mb-2 gap-5 h-auto w-40 bg-slate-600 p-4 flex flex-col rounded-lg justify-center items-center">
