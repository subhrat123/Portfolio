...
export const Navbar=()=>{
    ...
    <div className=" max-lg:pb-4 sticky max-lg:h-auto nav flex flex-wrap px-6 pt-6 rounded align item-center justify-around bg-gradient-to-r from-blue-400 to-fuchsia-500">
            ...
            {(!isLogedin) ?
               ...
               :
                <div className="flex justify-end"> 
                    <button className=" bg-pink-600 rounded-lg  px-2 mb-3"><a href="/Logout">Logout</a></button>
